    ...
    <div class="msform top_50">
        <fieldset class="box01">
            ...
            <div class="box01-bd">
                ...
                <div class="item-row">
                    <asp:Button ID="Button1" CssClass="border_button" runat="server" Text="问题补充" OnClick="Button1_Click" />
                </div>
                ...
                <div class="item-row">
                    <div class="box-tag">
                        ...
                        <div class="cont labels">
                            <a href="" class="label-blue">纽约</a>
                            <a href="" class="label-blue">洛杉矶</a>
                            <a href="" class="label-blue">旧金山</a>
                            <a href="" class="label-blue">波士顿</a>
                            <a href="" class="label-blue">芝加哥</a>
                        </div>
                    </div>
                    <div class="box-tag">
                        <span class="label">话题标签: </span>
                        <div class="cont labels">
                            <a href="" class="label-yellow">生活</a>
                            <a href="" class="label-yellow">工作</a>
                            <a href="" class="label-yellow">学习</a>
                            <a href="" class="label-yellow">学术</a>
                            <a href="" class="label-yellow">娱乐</a>
                            <a href="" class="label-yellow">生活</a>
                            <a href="" class="label-yellow">工作</a>
                            <a href="" class="label-yellow">学习</a>
                            <a href="" class="label-yellow">学术</a>
                ...
                <div class="item-row">
                    ...
                    <div class="cont">
                        <input type="text" style="width: 250px; padding: 3px; font-size: 16px; height: 20px;margin-right: 5px;" plcaeholder="请在20字以内"><input name="ctl00$ContentHolder$Button5" value="确定" id="ContentHolder_Button5" class="border_button" type="submit">
                    </div>
                </div>
            </div>
            <div class="btns-box">
