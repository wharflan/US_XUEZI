...
{
    public partial class BusinessPublish : System.Web.UI.Page
    {
        ...
        protected void fillblank()
        {
            ...
            if (mps.Business_TypeID != null && mps.Business_TypeID != 0)
            {
                DropDownList1.SelectedValue = mps.Business_TypeID.ToString();
            }
            else
            {
        ...
        protected Boolean BuildModel()
        {
            try
            {
                ...
                mps.Business_TypeID = int.Parse(DropDownList1.SelectedValue);
