...
namespace Maticsoft.DAL
{
	...
	public partial class Tb_UsertoReply
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Operation_ID", "Tb_UsertoReply"); 
		}
		...
		public bool Exists(int Operation_ID)
		{
			...
			strSql.Append("select count(1) from Tb_UsertoReply");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.Tb_UsertoReply model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Tb_UsertoReply(");
			strSql.Append("Operation_UserID,Opertaion_ReplyId,Operation_Type,Operation_Time)");
			strSql.Append(" values (");
			strSql.Append("@Operation_UserID,@Opertaion_ReplyId,@Operation_Type,@Operation_Time)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@Operation_UserID", SqlDbType.Int,4),
					new SqlParameter("@Opertaion_ReplyId", SqlDbType.Int,4),
			...
			parameters[1].Value = model.Opertaion_ReplyId;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.Tb_UsertoReply model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Tb_UsertoReply set ");
			strSql.Append("Operation_UserID=@Operation_UserID,");
			strSql.Append("Opertaion_ReplyId=@Opertaion_ReplyId,");
		...
		public bool Delete(int Operation_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Tb_UsertoReply ");
			strSql.Append(" where Operation_ID=@Operation_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@Operation_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Tb_UsertoReply GetModel(int Operation_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Operation_ID,Operation_UserID,Opertaion_ReplyId,Operation_Type,Operation_Time from Tb_UsertoReply ");
			strSql.Append(" where Operation_ID=@Operation_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@Operation_ID", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.Tb_UsertoReply model=new Maticsoft.Model.Tb_UsertoReply();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Tb_UsertoReply DataRowToModel(DataRow row)
		{
			Maticsoft.Model.Tb_UsertoReply model=new Maticsoft.Model.Tb_UsertoReply();
			if (row != null)
			{
				...
				if(row["Opertaion_ReplyId"]!=null && row["Opertaion_ReplyId"].ToString()!="")
				{
					model.Opertaion_ReplyId=int.Parse(row["Opertaion_ReplyId"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Operation_ID,Operation_UserID,Opertaion_ReplyId,Operation_Type,Operation_Time ");
			strSql.Append(" FROM Tb_UsertoReply ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Operation_ID,Operation_UserID,Opertaion_ReplyId,Operation_Type,Operation_Time ");
			strSql.Append(" FROM Tb_UsertoReply ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Tb_UsertoReply T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Tb_UsertoReply";
