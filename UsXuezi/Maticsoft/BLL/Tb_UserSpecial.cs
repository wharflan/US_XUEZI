...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.Tb_UserSpecial dal=new Maticsoft.DAL.Tb_UserSpecial();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.Tb_UserSpecial GetModelByCache(int User_ID)
		{
			
			string CacheKey = "Tb_UserSpecialModel-" + User_ID;
			...
			return (Maticsoft.Model.Tb_UserSpecial)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.Tb_UserSpecial> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.Tb_UserSpecial> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.Tb_UserSpecial> modelList = new List<Maticsoft.Model.Tb_UserSpecial>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Tb_UserSpecial model;
