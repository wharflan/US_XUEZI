...
CKEDITOR.editorConfig = function (config) {
    ...
    */
    ...
    config.defaultlanguage = 'zh-cn'; //≈‰÷√”Ô—‘   
    ...
    */
    [
        ['Undo', 'Redo'], ['Bold', 'Italic', 'Underline'], ['TextColor', 'BGColor'], ['Font', 'FontSize'],['Image', 'Table'], ['NumberedList', 'BulletedList', 'Blockquote'], ['Link', 'Unlink'], ['JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyBlock'], ['Source', '-', 'PasteFromWord']
    ];
};
